      ...
      <form className="max-w-2xl mx-auto" onSubmit={onSubmit}>
        <div className="grid [grid-template-columns:var(--cols-auto)] gap-6 mt-10 mb-8">
          <input
            ...
            required
            className="flex-1 p-3 outline-none border-[0.5px] border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <input
            type="email"
            name="email"
        ...
        <textarea
          ...
          required
          className="w-full p-4 outline-none border-[0.5px] border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
        ></textarea>
